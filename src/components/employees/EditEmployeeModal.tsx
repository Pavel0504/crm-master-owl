...
import { Employee, EmployeeInput, ALL_PAGES } from '../../services/employeeService';
...
export default function EditEmployeeModal({
  ...
  useEffect(() => {
    if (employee) {
      setFormData({
        ...
        position_color: employee.position_color,
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Редактировать сотрудника" size="lg">
